...
function GalleryCard({
  ...
  return (
    <div
      className="group relative h-full w-full overflow-hidden rounded-2xl transition-shadow duration-500 hover:shadow-[0_28px_60px_-18px_rgba(255,255,255,0.45)]"
      style={{
        background: '#061428',
    ...
    >
      ...
      {/* Glow cian al hover */}
      <div className="pointer-events-none absolute inset-0 opacity-0 transition-opacity duration-500 group-hover:opacity-100 bg-[radial-gradient(ellipse_at_top,rgba(255,255,255,0.35),transparent_60%)] mix-blend-overlay" />
