    ...
    >
      <div
        ...
        style={{
          background:
            'linear-gradient(160deg, rgba(14,34,71,0.98) 0%, rgba(4,12,26,0.99) 100%)',
          border: '1px solid rgba(10,31,61,0.4)',
          boxShadow:
            '0 30px 80px rgba(0,0,0,0.6), 0 0 60px rgba(10,31,61,0.2), inset 0 1px 0 rgba(255,255,255,0.1)',
        }}
        onClick={(e) => e.stopPropagation()}
      >
        {/* Banner */}
        <div className="relative overflow-hidden px-7 pb-5 pt-6">
          <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(10,31,61,0.25),transparent_60%)]" />
          <button
            onClick={onClose}
            aria-label="Cerrar"
