    ...
    >
      <defs>
        ...
        >
          ...
          <stop offset="0.52" stopColor="#0A1F3D" />
        </linearGradient>
      </defs>
      {iconos[icono]}
    </svg>
                  ...
                  <div className="card-flip3d">
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{
                          background:
                            'linear-gradient(160deg, rgba(255,255,255,0.14), rgba(10,31,61,0.12))',
                          border: '1px solid rgba(255,255,255,0.18)',
                          boxShadow: '0 8px 24px -8px rgba(10,31,61,0.35)',
                        }}
                      >
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{
                          background:
                            'linear-gradient(160deg, rgba(255,255,255,0.14), rgba(10,31,61,0.14))',
                          border: '1px solid rgba(255,255,255,0.2)',
                          boxShadow: '0 10px 30px -10px rgba(10,31,61,0.45)',
                        }}
                      >
