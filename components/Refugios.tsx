    ...
    >
      ...
      <div className="container relative py-16 md:py-24">
        ...
        <Reveal className="mx-auto max-w-3xl text-center">
          <span className="inline-flex items-center gap-2.5 rounded-full border-2 border-brand-cyan/70 bg-brand-navyDeep px-6 py-2.5 text-base font-bold uppercase tracking-[0.25em] text-brand-cyan shadow-[0_8px_28px_-6px_rgba(255,255,255,0.55),inset_0_1px_0_rgba(255,255,255,0.12)]">
                  ...
                  <div className="card-flip3d">
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{
                          background:
                            'linear-gradient(160deg, rgba(255,255,255,0.14), rgba(255,255,255,0.12))',
                          border: '1px solid rgba(255,255,255,0.18)',
                          boxShadow: '0 8px 24px -8px rgba(255,255,255,0.35)',
                        }}
                      >
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{
                          background:
                            'linear-gradient(160deg, rgba(255,255,255,0.14), rgba(255,255,255,0.14))',
                          border: '1px solid rgba(255,255,255,0.2)',
                          boxShadow: '0 10px 30px -10px rgba(255,255,255,0.45)',
                        }}
                      >
