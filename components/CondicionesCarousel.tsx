        ...
        {track.map((c, i) => (
          ...
          >
            <span
              ...
              style={{
                background:
                  'linear-gradient(160deg, rgba(10,31,61,0.28), rgba(10,31,61,0.1))',
                border: '1px solid rgba(10,31,61,0.5)',
                boxShadow: '0 0 18px rgba(10,31,61,0.3)',
              }}
            >
              <svg
                width="14"
