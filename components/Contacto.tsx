              ...
              {items.map((item, i) => (
                ...
                >
                  <a
                    ...
                    className="glass group flex items-center gap-4 rounded-2xl p-5 transition-all duration-300 hover:-translate-y-0.5 hover:!border-brand-cyan/50 hover:!bg-white/[0.09] hover:shadow-[0_16px_36px_-16px_rgba(255,255,255,0.4)]"
                  >
                    <div
