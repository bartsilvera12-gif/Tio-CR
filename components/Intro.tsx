...
function Billboard() {
  ...
  return (
    ...
    >
      {/* Halo cian muy sutil */}
      <div className="pointer-events-none absolute -inset-16 -z-10 bg-[radial-gradient(circle,rgba(255,255,255,0.1),transparent_70%)] blur-3xl" />
