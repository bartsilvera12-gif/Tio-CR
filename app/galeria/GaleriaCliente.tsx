          ...
          <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {photos.slice(0, limit).map((p, i) => (
              <button
                ...
                className="group relative aspect-[4/3] overflow-hidden rounded-2xl bg-brand-navyDeep text-left transition-shadow duration-500 hover:shadow-[0_28px_60px_-18px_rgba(47,123,255,0.5)]"
              ...
              >
                ...
                <div className="pointer-events-none absolute inset-0 opacity-0 transition-opacity duration-500 group-hover:opacity-100 bg-[radial-gradient(ellipse_at_top,rgba(47,123,255,0.32),transparent_60%)] mix-blend-overlay" />
  ...
  return (
    <a
      ...
      className={`inline-flex items-center gap-2 rounded-full border px-4 py-2 text-sm font-semibold transition-all duration-300 ${
        active
          ? 'border-brand-cyan bg-brand-cyan/20 text-brand-cyan shadow-[0_4px_18px_-6px_rgba(47,123,255,0.5)]'
